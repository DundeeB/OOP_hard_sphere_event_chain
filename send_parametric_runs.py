...
def main():
    ...
    send_single_run_envelope(h=1.0, n_row=150, n_col=150, rhoH=0.85, initial_conditions='square')
    send_single_run_envelope(h=1.0, n_row=150, n_col=150, rhoH=0.85, initial_conditions='honeycomb')
